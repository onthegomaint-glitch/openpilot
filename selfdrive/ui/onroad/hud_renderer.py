...
from openpilot.selfdrive.ui.onroad.freeze_frame_button import FreezeFrameButton, freeze_button_rect_for_hud
...
class HudRenderer(Widget):
  def __init__(self):
    ...
    self._freeze_button = FreezeFrameButton()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    self._freeze_button.render(freeze_button_rect_for_hud(rect))
  ...
  def handle_mouse_event(self) -> bool:
    if self._freeze_button.handle_mouse_event():
      return True
